...
export default function RecentPage() {
  ...
  const fetchListings = useCallback(async (pageNum: number, reset = false) => {
    ...
    const { data } = await supabase
      .from('listings')
      .select(
        'id, name, price, photos_url, category_name, category_id, latitude, longitude, location_data, created_at, owner:profiles!listings_owner_id_fkey(id, username, photo_url, is_pro, location_data)'
      )
      .eq('is_active', true)
          ...
          <View style={styles.webGridWrapper}>
            ...
            {!loading && listings.length === 0 && (
              <View style={styles.emptyState}>
                ...
                <Text style={styles.emptySubtitle}>Revenez bientôt pour de nouvelles annonces</Text>
              </View>
            )}
          </View>
        </ScrollView>
