-- 1. Replace the CHECK constraint with the statuses actually used by the app
...
-- 2. Fix update_booking_status RPC: column names were wrong
--    DB has: handover_confirmed_owner / handover_confirmed_renter
--           return_confirmed_owner   / return_confirmed_renter
--    RPC had: owner_handover_confirmed / renter_handover_confirmed
